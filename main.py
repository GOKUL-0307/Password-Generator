...
def pwGenerator(size = 8):
    ...
    lbl_strength.configure(foreground="white", background="green", text=pw_strength, font=('sans serif', 10, 'bold'), bd=10, height=1, width=10)
    gui.clipboard_clear()
...
Form.configure(bg='#5afab5')
#====================================LABEL WIDGET===============================
lbl_title = Label(Top, width=width, font=('sans serif', 16, 'bold'), text="Password Generator", relief=SOLID)
